        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", marginTop: "2%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", width: "82%" }}>
              ...
              <HoverButton text="Compose" ref={hoverRef2} onclick={() => navigate("/composetext")} color="#D2B48C" width="165px" height="200px"></HoverButton>
            ...
            <WaveCard text={waveCardProps.text} infoStyle={{ color: "#00695c", fontSize: "40px", marginLeft: "20px", marginRight: "20px", marginTop: "-20px" }} cardStyle={{ width: "1200px", height: "500px", margin: "-200px auto", transform: "perspective(500px) rotateX(35deg)" }} waveStyle={{ width: "1700px", height: "1800px", marginLeft: "-20%", marginTop: "-20%" }} colors={waveCardProps.colors} />
          </div>
        </div>
      </CSSTransition>
    </motion.div>
