...
import { handleClick, generateFromAudio, uploadFileAndGenerate } from "../../services/Api.js";
...
const Melody = () => {
	...
	const onStop = async (recordedBlob) => {
		...
		try {
			...
			handleClick("", navigate, fileUrl, blobName);
		} catch (error) {
	...
	return (
		<motion.div
			...
			<div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "78vh" }}>
				...
				<div style={{ display: "flex", alignItems: "center", flexDirection: "row", marginTop: "15px", justifyContent: "space-between", width: "30%" }}>
					<div>
						<HoverButton
