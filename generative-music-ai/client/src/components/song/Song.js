            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "70vh" }}>
                <div style={{ display: "flex", justifyContent: "space-between", width: "40%" }}>
                    <div style={{ backgroundColor: "#f0f0f0", border: "15px solid #000", borderRadius: "10px", width: "100%", height: "70%", marginTop: "2%", marginBottom: "30px", position: "relative", overflow: "hidden", transition: "all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1)", boxShadow: "5px 5px 0 #000, 10px 10px 0 #FFB6C1" }}>
                        <audio
                            style={{ backgroundColor: "#f0f0f0", borderRadius: "10px", boxShadow: "0px 0px 10px rgba(0,0,0,0.1)", width: "100%", height: "100%" }}
                            id="audioPlayer"
                            controls
                            src={songUrl}
                        >
                ...
                {/* <Button
                    onClick={() => navigate("/")}
                    style={{ margin: "10px", width: "200px", height: "80px", color: "black", backgroundColor: "pink" }}
                >
                    Start Over
                </Button> */}
            </div>
